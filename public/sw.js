const staticCacheStorage = "rancko-solutions-static-v4";
const dynamicCacheStorage = "rancko-solutions-dynamic-v4";
...
const staticAssets = [
	...
	"/manifest.json",
	"/css/style.css",
	"/css/github-widget.css",
	"/js/script.js",
	"/js/github-widget.min.js",
				...
				return (
					...
					fetch(event.request).then((fetchedResponse) => {
						return caches.open(dynamicCacheStorage).then((cache) => {
							...
							cacheSizeLimiter(dynamicCacheStorage, 20);
